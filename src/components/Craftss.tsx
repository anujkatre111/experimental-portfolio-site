...
type Props = {
  ...
  const Craftss = ({name,description}:Props) => {
    return (
      <div className='w-[500px] py-[10px] hover:px-[10px] flex flex-col gap-[4px] rounded-sm hover:bg-green-50 my-[4px] hover:cursor-pointer transition-all ease-in-out hover:scale-105 group'>
